...
* Where will this application module be hosted? "on premises" datacenter? Private cloud? IaaS? PaaS? other?
* Who will operate this application module? internally? Outsourced? No administration at all (PaaS) ...?
