...
.*2-Types of VPC*
. *Default vcp:* default internet gateway is available hence can communicate to internet

. *Custom vcp:* default internet gateway is not available hence cannot communicate to internet. but you can create internet gateway and talk to internet.
